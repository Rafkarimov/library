...
//
//import static com.nv.sberschool.library.constants.SecurityConstants.AUTHORS_PERMISSION_LIST;
//import static com.nv.sberschool.library.constants.SecurityConstants.AUTHORS_WHITE_LIST;
//import static com.nv.sberschool.library.constants.SecurityConstants.BOOKS_PERMISSION_LIST;
//import static com.nv.sberschool.library.constants.SecurityConstants.BOOKS_WHITE_LIST;
//import static com.nv.sberschool.library.constants.SecurityConstants.RESOURCES_WHITE_LIST;
//import static com.nv.sberschool.library.constants.SecurityConstants.USERS_PERMISSION_LIST;
//import static com.nv.sberschool.library.constants.SecurityConstants.USERS_WHITE_LIST;
...
//            .requestMatchers(AUTHORS_WHITE_LIST.toArray(String[]::new)).hasAnyRole(ADMIN, LIBRARIAN)
...
//            .requestMatchers(AUTHORS_PERMISSION_LIST.toArray(String[]::new)).permitAll()
//        )
//        .exceptionHandling()
